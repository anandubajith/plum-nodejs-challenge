...
INSERT INTO members(organization_id, employee_id, email, first_name, middle_name, last_name, date_of_birth, gender)
    VALUES(1, 123, 'test@gmail.com', 'test', null, 'test', to_date('12/12/1999','DD/MM/YYYY') ,'male')
INSERT INTO members(organization_id, employee_id, email, first_name, middle_name, last_name, date_of_birth, gender)
    VALUES(1, 124, 'test2@gmail.com', 'test2', null, 'test2', to_date('12/12/1999', 'DD/MM/YYYY') ,'female')
